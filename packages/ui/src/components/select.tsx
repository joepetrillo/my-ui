...
} from "@my-ui/ui/components/select-variants";
    ...
    <SelectPrimitive.Portal {...portalProps}>
      ...
      >
        ...
        >
          ...
          <div className="relative h-full min-w-(--anchor-width) overflow-hidden rounded-lg border bg-popover not-dark:bg-clip-padding shadow-lg/5">

...
export function Card({
  ...
  const defaultProps = {
    className: cn(
      "relative flex flex-col rounded-2xl border bg-card not-dark:bg-clip-padding text-card-foreground shadow-xs/5 overflow-hidden",
      className
    ),
    "data-slot": "card",
  };

...
export function ToggleGroup({
  ...
  if (variant !== "default") {
    const toggleBeforeClassName =
      "*:data-[slot=toggle]:before:pointer-events-none *:data-[slot=toggle]:before:absolute *:data-[slot=toggle]:before:inset-0";
    layoutClassName =
      orientation === "horizontal"
        ? `${toggleBeforeClassName} *:not-first:rounded-s-none *:not-last:rounded-e-none *:not-first:border-s-0 *:not-last:border-e-0 *:not-first:not-data-[slot=separator]:before:-start-[0.5px] *:not-last:not-data-[slot=separator]:before:-end-[0.5px] *:not-first:before:rounded-s-none *:not-last:before:rounded-e-none`
        : `${toggleBeforeClassName} flex-col *:not-first:rounded-t-none *:not-last:rounded-b-none *:not-first:border-t-0 *:not-last:border-b-0 *:not-first:not-data-[slot=separator]:before:-top-[0.5px] *:not-last:not-data-[slot=separator]:before:-bottom-[0.5px] *:not-first:before:rounded-t-none *:not-last:before:rounded-b-none *:data-[slot=toggle]:not-last:before:hidden dark:*:last:before:hidden dark:*:first:before:block`;
  }
